...
const ConversationIllustration: React.FC = () => {
  ...
  return (
    <Svg width={220} height={160} viewBox="0 0 220 160">
      {/* Background elements */}
      <Rect x={10} y={40} width={60} height={100} rx={8} fill={tc.accentLight} opacity={0.4} />
      <Rect x={150} y={50} width={55} height={90} rx={8} fill={tc.accentMuted} opacity={0.5} />
      {/* Person 1 */}
      ...
      {/* Speech bubble */}
      <Rect x={30} y={20} width={50} height={28} rx={14} fill={tc.accentMuted} />
      <Circle cx={45} cy={34} r={3} fill={tc.white} />
      <Circle cx={55} cy={34} r={3} fill={tc.white} />
      <Circle cx={65} cy={34} r={3} fill={tc.white} />
      {/* Person 2 - partial */}
...
const PronunciationIllustration: React.FC = () => {
  ...
  return (
    <Svg width={220} height={160} viewBox="0 0 220 160">
      <Rect x={40} y={30} width={140} height={100} rx={12} fill={tc.accentMuted} opacity={0.5} />
      {/* Person */}
      ...
      {/* Mic icon */}
      <Rect x={165} y={55} width={20} height={35} rx={10} fill={tc.accent} />
      <Path d="M165 90 L185 90" stroke={tc.accent} strokeWidth={3} />
      <Path d="M175 90 L175 100" stroke={tc.accent} strokeWidth={3} />
      {/* Sound waves */}
      <Path d="M45 60 Q35 75 45 90" stroke={tc.accentLight} strokeWidth={2.5} fill="none" />
      <Path d="M35 55 Q22 75 35 95" stroke={tc.accentLight} strokeWidth={2} fill="none" />
    </Svg>
  );
};
...
const VocabularyIllustration: React.FC = () => {
  ...
  return (
    <Svg width={220} height={160} viewBox="0 0 220 160">
      ...
      <Rect x={5} y={40} width={50} height={100} rx={8} fill={tc.accentLight} opacity={0.3} />
      ...
      {/* Speech bubble */}
      <Rect x={45} y={15} width={55} height={30} rx={15} fill={tc.accentMuted} />
      <Circle cx={60} cy={30} r={3.5} fill={tc.white} />
      <Circle cx={72} cy={30} r={3.5} fill={tc.white} />
      <Circle cx={84} cy={30} r={3.5} fill={tc.white} />
      {/* Table / desk */}
      <Rect x={60} y={122} width={120} height={6} rx={3} fill={tc.accentLight} />
      {/* Book/paper */}
      <Rect x={85} y={108} width={30} height={18} rx={2} fill={tc.white} />
      <Path d="M90 113 L110 113" stroke={tc.textMuted} strokeWidth={1.5} />
      <Path d="M90 117 L105 117" stroke={tc.textMuted} strokeWidth={1.5} />
      <Path d="M90 121 L108 121" stroke={tc.textMuted} strokeWidth={1.5} />
      {/* Plant */}
      <Rect x={155} y={108} width={7} height={16} rx={2} fill="#C4A882" />
      <Ellipse cx={158} cy={103} rx={10} ry={9} fill="#6BBF6B" />
      {/* Right person - partial */}
      <Rect x={175} y={50} width={40} height={90} rx={8} fill={tc.accentMuted} opacity={0.3} />
    </Svg>
  );
};
...
const LessonDetailScreen: React.FC = () => {
  ...
  const { detail, loading, starting, error, startLesson } = useLessonDetailController(lessonId);
  ...
  const Illustration = CATEGORY_ILLUSTRATIONS[detail.category] ?? VocabularyIllustration;
