    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity
          style={styles.exerciseCard}
          activeOpacity={0.8}
          onPress={() => (navigation as any).navigate('Tutor')}
        >
          ...
          <View style={styles.exerciseInfo}>
            ...
            <Text style={styles.exerciseDesc}>Expand your word bank with flashcards</Text>
          </View>
          <Ionicons name="chevron-forward" size={20} color={tc.textMuted} />
        </TouchableOpacity>
        ...
        >
          ...
          <View style={styles.exerciseInfo}>
            ...
            <Text style={styles.exerciseDesc}>Chat with AI and improve fluency</Text>
          </View>
          <Ionicons name="chevron-forward" size={20} color={tc.textMuted} />
        </TouchableOpacity>
