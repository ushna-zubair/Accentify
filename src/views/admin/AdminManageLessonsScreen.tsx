...
const DifficultyBadge: React.FC<{ difficulty: string; tc: ThemeColors }> = ({ difficulty, tc }) => {
  ...
  return (
    <View
      style={{ backgroundColor: c.bg, paddingVertical: 3, paddingHorizontal: 8, borderRadius: 12 }}
    >
  ...
  return (
    ...
    >
      ...
      <View style={{ padding: 16 }}>
          ...
          <View style={{ position: 'relative' as any, zIndex: showActions ? 50 : undefined }}>
            <TouchableOpacity
              ...
              style={{
                ...
                height: 32,
                borderRadius: 8,
                backgroundColor: showActions ? tc.accent + '12' : tc.surfaceAlt,
                justifyContent: 'center',
                alignItems: 'center',
              }}
              activeOpacity={0.7}
            >
              <Ionicons
                ...
                size={16}
                color={showActions ? tc.accent : tc.textLight}
              />
            </TouchableOpacity>
            {showActions && (
              <TouchableOpacity
        ...
        {/* Title */}
        <Text
          style={{ fontFamily: fonts.bold, fontSize: 16, color: tc.text, marginBottom: 4 }}
          numberOfLines={2}
        >
          {lesson.title}
        </Text>
        ...
        >
          ...
          {(lesson.level ?? 0) > 0 && (
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
              ...
              <Text style={{ fontFamily: fonts.medium, fontSize: 11, color: tc.accent }}>
                Level {lesson.level}
              </Text>
            </View>
          )}
  ...
  return (
    ...
    >
      ...
      <View style={{ flexDirection: 'row', gap: 10, marginBottom: 10 }}>
        <View style={{ flex: 1 }}>
          ...
          <TextInput
            ...
            value={data.basicWord}
            onChangeText={(v) => updateField('basicWord', v)}
          />
        </View>
        <View style={{ flex: 1 }}>
          ...
          <TextInput
            style={inputStyle}
            placeholder="e.g. Assist"
            placeholderTextColor={tc.textMuted}
            value={data.vocabWord}
            onChangeText={(v) => updateField('vocabWord', v)}
          />
        </View>
      </View>
      ...
      <View style={{ flexDirection: 'row', gap: 10, marginBottom: 10 }}>
        <View style={{ flex: 1 }}>
          ...
          <TextInput
            ...
            placeholder="e.g. help"
            placeholderTextColor={tc.textMuted}
            value={data.basicPhonetic}
            onChangeText={(v) => updateField('basicPhonetic', v)}
          />
        </View>
        <View style={{ flex: 1 }}>
          ...
          <TextInput
            style={inputStyle}
            placeholder="e.g. uh-sist"
            placeholderTextColor={tc.textMuted}
            value={data.vocabPhonetic}
            onChangeText={(v) => updateField('vocabPhonetic', v)}
          />
        </View>
      </View>
      ...
      <View style={{ flexDirection: 'row', gap: 10, marginBottom: 10 }}>
        <View style={{ flex: 1 }}>
          ...
          <TextInput
            ...
            placeholder="Definition of the basic word…"
            placeholderTextColor={tc.textMuted}
            value={data.basicDefinition}
            onChangeText={(v) => updateField('basicDefinition', v)}
            multiline
          />
        </View>
        <View style={{ flex: 1 }}>
          ...
          <TextInput
            style={{ ...inputStyle, minHeight: 56, textAlignVertical: 'top' }}
            placeholder="Definition of the vocab word…"
            placeholderTextColor={tc.textMuted}
            value={data.vocabDefinition}
            onChangeText={(v) => updateField('vocabDefinition', v)}
            multiline
          />
        </View>
      </View>
      ...
      <TextInput
        ...
        placeholder="Use both words in a sentence…"
        placeholderTextColor={tc.textMuted}
        value={data.exampleSentence}
        onChangeText={(v) => updateField('exampleSentence', v)}
      />
      ...
      <View style={{ flexDirection: 'row', gap: 10, justifyContent: 'flex-end' }}>
        <TouchableOpacity
          ...
          activeOpacity={0.7}
        >
          <Text style={{ fontFamily: fonts.medium, fontSize: 13, color: tc.textLight }}>
            Cancel
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
...
const LessonFormModal: React.FC<{
  ...
  const availablePrereqs = allLessons.filter(
    (l) =>
      !formData.prerequisites.includes(l.id) &&
      l.id !== (isEditing ? allLessons.find((x) => x.title === formData.title)?.id : ''),
  );
                  ...
                  >
                    <View
                      style={{
                        ...
                        height: 22,
                        borderRadius: 11,
                        backgroundColor: isActive ? tc.accent : tc.disabled,
                        justifyContent: 'center',
                        alignItems: 'center',
                      }}
                    >
                      <Text style={{ fontFamily: fonts.bold, fontSize: 11, color: tc.white }}>
                        {idx + 1}
                      </Text>
                    </View>
                    <Ionicons
                    ...
                    <Text
                      style={{
                        ...
                        fontSize: 13,
                        color: isActive ? tc.accent : tc.textLight,
                      }}
                    >
                      {stepLabel}
                    </Text>
            ...
            {formStep === 'details' && (
              <>
                ...
                <SectionHeader
                  ...
                  subtitle="Core lesson details"
                />

                {/* Title */}
                <Text style={labelStyle}>
                  Title <Text style={{ color: tc.error }}>*</Text>
                </Text>
                <TextInput
                  style={inputStyle}
                ...
                {/* Short Description */}
                <Text style={labelStyle}>
                  Short Description <Text style={{ color: tc.error }}>*</Text>
                </Text>
                <TextInput
                ...
                <SectionHeader
                  ...
                  subtitle="Category, difficulty, and level"
                />

                {/* Category */}
                <Text style={labelStyle}>
                  Category <Text style={{ color: tc.error }}>*</Text>
                </Text>
                    ...
                    return (
                      ...
                      >
                        <Ionicons
                          ...
                          size={14}
                          color={selected ? cc.text : tc.textLight}
                        />
                        <Text
                          style={{
                      ...
                      >
                        <Text
                          style={{
                            fontFamily: selected ? fonts.semiBold : fonts.medium,
                            fontSize: 12,
                            color: selected ? dc.text : tc.textLight,
                          }}
                        >
                          {diff}
                        </Text>
                ...
                <SectionHeader
                  ...
                  subtitle="Publishing state and passing criteria"
                />
                      ...
                      >
                        <Text
                          style={{
                            fontFamily: selected ? fonts.semiBold : fonts.medium,
                            fontSize: 12,
                            color: selected ? sc.text : tc.textLight,
                          }}
                        >
                ...
                <View style={{ flexDirection: 'row', gap: 12 }}>
                  <View style={{ flex: 1 }}>
                    <Text style={labelStyle}>
                      Passing Score
                      <Text
                        style={{ fontFamily: fonts.regular, fontSize: 11, color: tc.textMuted }}
                      >
                        {' '}
                        (0–100)
                      </Text>
                ...
                <SectionHeader
                  icon="image"
                  title="Media"
                  subtitle="Lesson images and illustrations"
                />
                ...
                <Text style={labelStyle}>
                  ...
                  <Text style={{ fontFamily: fonts.regular, fontSize: 11, color: tc.textMuted }}>
                    {' '}
                    (shown on lesson detail/intro page)
                  </Text>
                </Text>
                <TextInput
                  style={inputStyle}
                ...
                <Text style={labelStyle}>
                  ...
                  <Text style={{ fontFamily: fonts.regular, fontSize: 11, color: tc.textMuted }}>
                    {' '}
                    (celebration screen after finishing)
                  </Text>
                </Text>
                <TextInput
                  style={inputStyle}
                ...
                <SectionHeader
                  icon="bulb"
                  title="Focus Tips"
                  subtitle="Study tips shown on the intro screen"
                />
                ...
                <SectionHeader
                  icon="pricetags"
                  title="Tags"
                  subtitle="Keywords for organization and search"
                />
                <View style={{ flexDirection: 'row', gap: 8, marginBottom: 8 }}>
                  <TextInput
                    style={{ ...inputStyle, flex: 1, marginBottom: 0 }}
                ...
                <SectionHeader
                  ...
                  subtitle="What users see after finishing the lesson"
                />
                ...
                <SectionHeader
                  icon="git-branch"
                  title="Prerequisites"
                  subtitle="Lessons that must be completed first"
                />
              ...
              <>
                ...
                {!loadingPairs && (
                  ...
                  >
                    ...
                    >
                      Each word pair consists of a basic word and its advanced vocabulary
                      equivalent. Users will practice pronouncing both and learn definitions.
                    </Text>
                  </View>
                )}
                ...
                {!loadingPairs && formData.vocabPairs.length === 0 && !pairFormVisible && (
                  <View style={{ alignItems: 'center', paddingVertical: 30 }}>
                    ...
                    >
                      Add vocabulary word pairs for students to practice pronunciation and learn
                      definitions
                    </Text>
                  </View>
                )}
          ...
          >
            ...
            <TouchableOpacity
              style={{
                ...
                alignItems: 'center',
                opacity:
                  !formData.title.trim() || !formData.description.trim() || submitting ? 0.5 : 1,
              }}
              onPress={onSave}
    ...
    <View style={{ flex: 1, backgroundColor: tc.background }}>
      ...
      >
        ...
        >
          ...
          {/* Category dropdown */}
          <View
            style={{ position: 'relative' as any, zIndex: showCategoryFilter ? 20 : undefined }}
          >
            <TouchableOpacity
              style={{
                flexDirection: 'row',
            ...
            >
              ...
              >
                {ctrl.categoryFilter === 'all'
                  ? 'Category'
                  : LESSON_CATEGORY_LABELS[ctrl.categoryFilter]}
              </Text>
              <Ionicons
                  ...
                  return (
                    ...
                    >
                      <Ionicons
                        name={categoryIcon(cat) as any}
                        size={16}
                        color={ctrl.categoryFilter === cat ? tc.accent : cc.text}
                      />
                      <Text
                        style={{
                          fontFamily: fonts.medium,
