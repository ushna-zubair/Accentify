...
const VerifyEmailScreen: React.FC<Props> = ({ route, navigation }) => {
  ...
  const handleOpenEmail = async () => {
    ...
    const urlsToTry = Platform.OS === 'ios' ? ['googlegmail://', 'message://'] : ['googlegmail://'];
        ...
        <Animated.View entering={FadeInDown.duration(500).springify()} style={styles.card}>
          ...
          <View style={styles.cardContent}>
            ...
            <View style={styles.buttonContainer}>
              ...
              >
                <Text style={styles.okayButtonText}>{verifying ? 'Checking...' : 'Okay'}</Text>
              </TouchableOpacity>
            ...
            >
              <Text
                style={[styles.resendText, (resendCooldown > 0 || loading) && styles.disabledText]}
              >
